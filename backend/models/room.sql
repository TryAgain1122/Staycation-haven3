...
CREATE TABLE IF NOT EXISTS haven_images (
    id SERIAL PRIMARY KEY,
    haven_id INTEGER NOT NULL REFERENCES havens(id) ON DELETE CASCADE,
    image_url TEXT NOT NULL,
    cloudinary_public_id VARCHAR(255),
    display_order INTEGER DEFAULT 0,
    uploaded_at TIMESTAMP DEFAULT NOW(),
    
    CONSTRAINT fk_haven FOREIGN KEY (haven_id) REFERENCES havens(id)
);

-- ===============================================
-- 3. PHOTO TOUR IMAGES TABLE (Category-based photos)
-- ===============================================
CREATE TABLE IF NOT EXISTS photo_tour_images (
    id SERIAL PRIMARY KEY,
    haven_id INTEGER NOT NULL REFERENCES havens(id) ON DELETE CASCADE,
    ...
    CONSTRAINT fk_haven_photo_tour FOREIGN KEY (haven_id) REFERENCES havens(id),
...
CREATE TABLE IF NOT EXISTS blocked_dates (
    ...
    CONSTRAINT fk_haven_blocked FOREIGN KEY (haven_id) REFERENCES havens(id),
